...
class _StationInfoScreenState extends State<StationInfoScreen> {
                ...
                DefaultTabController(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        height: arrivalInfo.isEmpty ? 6 : 250,
                        child: TabBarView(
                          children: [
                            _buildDirectionInfo(true),
                            _buildDirectionInfo(false),
                          ],
                        ),
                      ),
                    ],
  ...
  Widget _buildDirectionInfo(bool isUpward) {
    final filteredInfo = arrivalInfo.where((info) {
      final isUp = info['updnLine'].toString().contains('상행') ||
          info['updnLine'].toString().contains('내선');
